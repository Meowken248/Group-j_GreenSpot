...
def upgrade() -> None:
    ...
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('is_anonymous_by_default', sa.Boolean(), nullable=False),
    sa.Column('hide_exact_gps', sa.Boolean(), nullable=False),
    sa.Column('spatial_jitter_radius_meters', sa.Integer(), nullable=False),
    sa.Column('mask_phone_number', sa.Boolean(), nullable=False),
    sa.Column('allow_push_notifications', sa.Boolean(), nullable=False),
